...
// APIClient manages communication with the Brev API API v0.1.0
...
type APIClient struct {
	...
	WorkspaceGroupsApi *WorkspaceGroupsApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.WorkspaceGroupsApi = (*WorkspaceGroupsApiService)(&c.common)
