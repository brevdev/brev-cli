...
brev create my-box | brev exec "pip install torch"
...
# With specific GPU
brev search --gpu-name A100 | brev create ml-box | brev exec @ml-setup.sh
```
...
# Or pipe from create
brev create my-cluster --count 3 | brev exec @setup.sh
```
