...
import (
	...
	"github.com/brevdev/brev-cli/pkg/entity" //nolint:typecheck // uses generic code
...
func NewCmdCreate(t *terminal.Terminal, createStore CreateStore, noLoginCreateStore CreateStore) *cobra.Command {
	var detached bool
	var gpu string
	var cpu string
	...
	cmd := &cobra.Command{
		...
		// ValidArgsFunction:     completions.GetAllWorkspaceNameCompletionHandler(noLoginCreateStore, t),
